 ...
 * @LastEditTime: 2022-03-05 14:53:09
...
class _MusicPageState extends State<MusicPage> {
  ...
  Widget build(BuildContext context) {
    return Consumer<SequenceState?>(
      builder: (context, sequenceState, child) {
          ...
          children: [
            ...
            Container(
                ...
                child: CachedNetworkImage(
                  fit: BoxFit.cover,
                  width: double.infinity,
                  imageUrl: '${metadata.album.picUrl}',
